...
class SeeAll2 extends StatelessWidget {
            ...
            builder: (context, snapshot) {
              ...
              if (snapshot.connectionState == ConnectionState.done &&
                  ...
                  snapshot.data.docs.forEach((doc) {
                    ...
                    if (position != null) {
                      print(Geolocator.distanceBetween(
                          position.latitude,
                          position.longitude,
                          doc.data()['vendorGeo'].latitude,
                          doc.data()['vendorGeo'].longitude));
                ...
                return position != null
                    ...
                    : Center(child: Text('Your Location is off :('));
              } else {
                return Center(
